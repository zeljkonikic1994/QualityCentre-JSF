...
CREATE TABLE IF NOT EXISTS `specificstep` (
  ...
  KEY `fk_specific_test_status` (`status_id`)
...
INSERT INTO `specificstep` (`id`, `test_set_id`, `name`, `description`, `expected`, `folder`, `status_id`) VALUES
(1, 13, 'Plug in headphones', 'Launch the game and plug in the headphones', 'Sound shoud continue playing through headphones', 'Sound_test', 1),
(1, 14, 'Game_Load', 'Load the game on an iOS device', 'Game loads normally', 'New_folder', 2),
(1, 15, 'Basic functionality', 'Make sure that game basic functionalities are working', 'All basic functionalities are working\r\n', 'Sound_test', 1),
(1, 16, 'Plug in headphones', 'Launch the game and plug in the headphones', 'Sound shoud continue playing through headphones', 'Sound_test', 1),
(2, 13, 'Plug out headphones', 'Launch the game with headphones plugged in and plug them out', 'Sound shoud continue playing through speakers', 'Sound_test', 1),
(2, 14, 'Orientation', 'Launch the game in portrait or landscape\r\nChange orientation', 'Game scales fine during orientation change', 'Compatibility_test', 1),
(2, 15, 'Bonus functionality', 'Make sure that game bonus functionalities are working', 'All bonus functionalities are working\r\n', 'Sound_test', 1),
(2, 16, 'Plug out headphones', 'Launch the game with headphones plugged in and plug them out', 'Sound shoud continue playing through speakers', 'Sound_test', 1),
(3, 14, 'Accept call', 'During the game is launched, call the device from another device', 'Game should pause during the conversation', 'New_folder', 2),
(3, 15, 'Sound', 'Make sure that sound is ok', 'Sound is ok', 'Sound_test', 1),
(3, 16, 'Game_Load', 'Load the game on an iOS device', 'Game loads normally', 'Compatibility_test', 2),
(4, 15, 'Responsive', 'Make sure that game is responsive', 'Game is responsive', 'Sound_test', 1),
(4, 16, 'Orientation', 'Launch the game in portrait or landscape\r\nChange orientation', 'Game scales fine during orientation change', 'Compatibility_test', 2),
(5, 15, 'Plug in headphones', 'Launch the game and plug in the headphones', 'Sound shoud continue playing through headphones', 'Sound_test', 3),
(5, 16, 'Accept call', 'During the game is launched, call the device from another device', 'Game should pause during the conversation', 'Compatibility_test', 4),
(6, 15, 'Plug out headphones', 'Launch the game with headphones plugged in and plug them out', 'Sound shoud continue playing through speakers', 'Sound_test', 3),
(555, 13, 'STEP 1', 'DESC', 'EXP', 'Timeout_test', 1),
(555, 14, 'STEP 1', 'DESC', 'EXP', 'New_folder', 1),
(555, 16, 'STEP 1', 'DESC', 'EXP', 'Compatibility_test', 4),
(556, 14, 'Game_Load', 'Load the game on an iOS device', 'Game loads normally', 'Compatibility_test', 4),
(556, 16, 'Basic functionality', 'Make sure that game basic functionalities are working', 'All basic functionalities are working\r\n', 'Smoke_test', 4),
(557, 14, 'Orientation', 'Launch the game in portrait or landscape\r\nChange orientation', 'Game scales fine during orientation change', 'Compatibility_test', 4),
(557, 16, 'Bonus functionality', 'Make sure that game bonus functionalities are working', 'All bonus functionalities are working\r\n', 'Smoke_test', 2),
(558, 14, 'Accept call', 'During the game is launched, call the device from another device', 'Game should pause during the conversation', 'Compatibility_test', 3),
(558, 16, 'Sound', 'Make sure that sound is ok', 'Sound is ok', 'Smoke_test', 2),
(559, 14, 'STEP 1', 'DESC', 'EXP', 'Compatibility_test', 1),
(559, 16, 'Responsive', 'Make sure that game is responsive', 'Game is responsive', 'Smoke_test', 1),
(560, 16, 'Request timeout', 'Wait until request times out', 'Game should display a message \"There has been an error\"', 'Timeout_test', 1),
(561, 16, 'Session timeout', 'Idle to session timeout', 'Game should display a message \"There has been an error\"', 'Timeout_test', 2);
...
(13, 'MONKEY_PRINCE', '2018-03-02', '2018-03-02'),
(14, 'BALLONIES', '2018-03-02', '2018-06-07'),
(15, 'BLACKJACK', '2018-03-02', '2018-06-07'),
(16, 'POKER', '2018-06-07', '2018-06-07');
...
ALTER TABLE `specificstep`
  ...
  ADD CONSTRAINT `fk_specific_test_status` FOREIGN KEY (`status_id`) REFERENCES `completion_status` (`status_id`) ON DELETE CASCADE ON UPDATE CASCADE;
